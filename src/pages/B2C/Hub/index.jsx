          ...
          {tab === "rastro" && (
            <div className="space-y-5">
              ...
              <div className="grid grid-cols-3 gap-4">
                ...
                <div className="bg-white rounded-2xl border border-gray-200 p-5 shadow-sm">
                  <div className="w-11 h-11 bg-blue-50 rounded-xl flex items-center justify-center text-xl mb-3"></div>
          ...
          {tab === "historico" && (
            <div className="space-y-5">
              ...
              <div className="bg-white rounded-2xl border border-gray-200 overflow-hidden shadow-sm">
                ...
                {[
                  {icon:"", title:"Pedágio — SP-280 KM 32",           date:"24 abr · 08:42", co2:"−1,8 kg"},
                  {icon:"", title:"Posto Shell — Marginal Pinheiros",   date:"23 abr · 17:15", co2:"−2,4 kg"},
                  {icon:"", title:"Estacionamento — Shopping Ibirapuera",date:"22 abr · 14:03", co2:"−0,9 kg"},
                  {icon:"", title:"Pedágio — Castelo Branco KM 18",     date:"21 abr · 06:58", co2:"−1,5 kg"},
                  {icon:"", title:"Posto BR Mania — Av. Paulista",       date:"20 abr · 11:22", co2:"−3,1 kg"},
                  {icon:"", title:"Pedágio — Anhanguera KM 54",         date:"18 abr · 07:30", co2:"−2,2 kg"},
                ].map((row,i) => (
