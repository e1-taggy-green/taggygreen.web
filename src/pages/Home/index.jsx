    ...
    <div className="min-h-screen bg-white flex flex-col">
      ...
      <section className="relative flex-1 flex flex-col items-center justify-center text-center px-4 sm:px-6 py-10 sm:py-16 overflow-hidden">
        ...
        <div className="absolute inset-0 pointer-events-none overflow-hidden">
          ...
          ></div>
          <div 
            className="absolute top-20 right-10 w-24 h-24 sm:w-32 sm:h-32 rounded-full" 
        ...
        <div className="relative z-10 w-full max-w-3xl mx-auto">
          ...
          <div className="inline-flex items-center gap-2 bg-green-50 border border-green-200 rounded-full px-3 py-1 sm:px-4 sm:py-1.5 text-xs sm:text-sm font-semibold text-green-700 mb-6 max-w-full truncate">
          ...
          <h1 className="text-4xl sm:text-5xl md:text-6xl font-black tracking-tight text-gray-900 leading-[1.1] mb-5 px-2" style={{ fontFamily: "'Syne',sans-serif" }}>
            Sua tag faz<br />
          ...
          <div className="bg-gray-950 rounded-2xl p-6 sm:px-8 sm:py-6 grid grid-cols-1 sm:grid-cols-3 gap-6 mb-10 sm:mb-14 max-w-2xl mx-auto shadow-xl">
            {[
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-5 text-left max-w-2xl mx-auto mb-8 px-2 sm:px-0">
          ...
          <div className="px-2 sm:px-0">
            <button 
              ...
              className="w-full max-w-2xl mx-auto flex flex-col sm:flex-row items-start sm:items-center justify-between gap-4 bg-gradient-to-r from-green-700 to-green-900 rounded-2xl p-6 sm:px-7 sm:py-5 hover:from-green-800 hover:to-green-950 transition-all group shadow-lg shadow-green-900/20 text-left"
            >
              <div>
              ...
              <div className="w-full sm:w-auto text-center bg-white text-green-800 font-bold text-sm px-5 py-2.5 rounded-xl group-hover:bg-green-50 transition-colors shadow">
                Ver Simulação →
              </div>
            </button>
          </div>
